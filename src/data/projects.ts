import type { Project } from '../components/Projects/Cell';

// TODO Add a couple lines about each project
const data: Project[] = [
  {
    title: 'OpenWallet Foundation: VC-API',
    subtitle: 'Open-source contribution',
    date: '2025-02-01',
    link: 'https://github.com/openwallet-foundation-labs/vc-api',
    desc: [
      'This repository provides a NestJs VC API implementation of the W3C Credentials Community Group VC API Specification.',
      'It provides a RESTful API for creating, verifying, and managing Verifiable Credentials and Verifiable Presentations.',
    ],
  },
  {
    title: 'ethersjs-azure-keyvault-signer',
    subtitle: 'Published on NPM',
    date: '2022-02-01',
  ...
  {
    title: 'LifeBlocks: A Blockchain based Insurance Platform',
    subtitle: 'Final Year B.E. Project',
    date: '2019-03-01',
